        ...
        <nav className="navbar-default navbar-fixed-top">
            <div className="container">
                ...
                <ul className={"nav navbar-nav"} >
                    ...
                    <li id="denovo" className="nav-item"><Link href="/files"><a className="nav-link"><i>De novo</i> genes</a></Link></li>
                    <li id="molEvo" className="nav-item"><Link href="/files"><a className="nav-link">Molecular Evolution</a></Link></li>
                    <li id="popGateway" className="nav-item"><Link href="/files"><a className="nav-link">Population Genetics</a></Link></li>
