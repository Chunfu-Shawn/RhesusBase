    ...
    return (
        <div className="modal-body-stw" style={contentStyle}>
            ...
            <Typography style={{marginTop:50,fontSize:16}}>
                ...
                <p>
                    This section aims to show you details of the criteria for datasets collection, basic ST analyses performed on our curated ST datasets
                    and tips for navigating them.
                </p>
                <h2>1. Criteria for collection</h2>
                <a id={"criteria_for_collection"} style={{position: 'relative', top: "-150px"}}></a>
                <p>
                    We searched for ST-related articles using keywords of &quot;spatial transcriptomics,&quot; &quot;spatial
                    transcriptomic,&quot; and &quot;spatial omics&quot; on PubMed, and included ST datasets that contain
                    both gene expression matrices and spatial coordinate information. To ensure the high quality of the
                    database, the ST datasets with both low spot resolution (&lt; 500 spots/cells) and low coverage (&lt;
                    10,000 detected genes) were discarded. Finally, we collected 100 public ST datasets from humans and
                    mice, with some of these datasets accompanied by imaging data of histological staining. Additionally,
                    we performed Stereo-seq on two sequential coronal sections (10 μm thickness) derived from an embryonic
                    mouse brain at E14.5. These ST data were categorized according to ST technologies, species, strains,
                    organs, tissues, developmental stages and pathological states. This resulted in a compilation of 101
                    ST datasets comprising 823 sections. All curated ST datasets were uniformly processed using centralized
                    pipelines. We have designed this interface to help you navigate through this catalog. Select the ST data
                    that you are interested in and explore the spatially resolved expression profiles of candidate genes.
                </p>
                ...
                <p>
                    We obtained the gene expression data and spatial location information of 101 sets of spatial
                    transcriptomic data through literature research, some of which contain the image data. A unified
                    python script was used to process the 101 sets of spatial transcriptomic data. The following is the
                ...
                <h2>6. Description of downloaded file</h2>
