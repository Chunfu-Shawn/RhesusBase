        ...
        <div className="modal-body-stw" style={contentStyle}>
            ...
            <Typography style={{marginTop:50,fontSize:16}}>
                ...
                <p>
                    ...
                    </a> by projecting these two modalities into shared latent space. To attenuate the confounding effects
                    caused by the incompatibility between the two modalities, we implement a filtering method called
                    coembedding filtering. This method filters out cells that are not well-mixed with ST spots in the
                    shared UMAP space. Specifically, the average Euclidean distance between each spot and its 50 nearest
                    neighbours (which can be adjusted through advanced parameters) is calculated. Then, we determine the
                    mean of these average distances as a threshold that measures the overall proximity of cells to ST spots.
                    Cells that are not within the scope of any ST spots were removed.
                </p>
                ...
                <ol>
                    <li>
                        ...
                        <p>
                            ...
                            (https://doi.org/10.1038/s41587-022-01233-1)</a>. Briefly, this method trains a multivariate RF model on ST data in the shared latent space and
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            </a> to identify marker genes using t test method in the scRNA-seq data. These marker genes
                            were then used as training genes to find the optimal spatial alignment for single cells
                            through the &quot;cell&quot; mapping mode. Subsequently, we mapped each single cell to the most probable
                            ST spot.
                        </p>
                    </li>
                    <li>
                        <b>CytoSPACE</b>
                        <p>
                            We used the default solver lapjv for a fast implementation of the Jonker-Volgenant shortest
                            augmenting path assignment algorithm. To achieve parallel processing, we used the spot
                            subsampling mode and set the number of subsampled cells per partition to the default value of 5,000.
                        </p>
                    </li>
                </ol>
